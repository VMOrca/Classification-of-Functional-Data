...
# - theta, mu, sigma: parameters in an OU process
...
# Function to calculate sample path for intensity process (not Hawkes process itself!)
...
# Function to plot trajectories of generated OU process
plotHawkes = function(t, HawkesSample, xMin, xMax, title = 'Intensity Process of a Hawkes Process') {
  n = dim(HawkesSample)[1]
  plot(t, HawkesSample[1, ], type = 'l', ylim = c(xMin, xMax), xlab = 't', ylab = 'Intensity', main = title)
  for (i in 1:n) {
